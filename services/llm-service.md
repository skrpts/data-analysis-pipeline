...
id: llm-service
title: LLM Service
description: "Language model service providing data analysis and findings synthesis capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for data analysis and findings synthesis. Used by all skills in this skrpt.
